    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersProgresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersProgresses_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersProgresses_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersProgresses_SubjectId",
                table: "UsersProgresses",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersProgresses_UserId",
                table: "UsersProgresses",
                column: "UserId");
        }
